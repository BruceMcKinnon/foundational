...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_what_input__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_foundation_sites__ = __webpack_require__(2);
//import $ from 'jquery';
...
function findFocusable($element) {
  ...
  return $element.find('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]').filter(function () {
    ...
    var aTabIndex = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(a).attr('tabindex'), 10),
        bTabIndex = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(b).attr('tabindex'), 10); // Undefined is treated the same as 0
...
function onTouchMove(e) {
  if (true === __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.spotSwipe.preventDefault) {
    e.preventDefault();
  }
...
function onTouchStart(e) {
  if (e.touches.length === 1) {
    ...
    this.addEventListener('touchmove', onTouchMove, {
      passive: true === __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.spotSwipe.preventDefault
    });
...
var SpotSwipe = /*#__PURE__*/function () {
  ...
  _createClass(SpotSwipe, [{
    ...
    value: function _init() {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.event.special.swipe = {
        setup: init
      };
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.event.special.tap = {
        setup: init
      };
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.each(['left', 'up', 'down', 'right'], function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.event.special["swipe".concat(this)] = {
      ...
      $elem.off('click.zf.drilldown').on('click.zf.drilldown', function (e) {
        ...
        if (_this.options.closeOnClick) {
          ...
          $body.off('.zf.drilldown').on('click.zf.drilldown', function (ev) {
            if (ev.target === _this.$element[0] || __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.contains(_this.$element[0], ev.target)) {
              return;
            }
...
var Sticky = /*#__PURE__*/function (_Plugin) {
  ...
  _createClass(Sticky, [{
    ...
    value: function _events(id) {
      ...
      if (this.canStick) {
        this.isOn = true;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).off(scrollListener).on(scrollListener, function () {
...
var Tabs = /*#__PURE__*/function (_Plugin) {
  ...
  _createClass(Tabs, [{
    ...
    value: function _collapseTab($target) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#".concat($targetAnchor.attr('aria-controls'))).removeClass("".concat(this.options.panelActiveClass)).attr({
        'aria-hidden': 'true'
      });
    }
    /**
